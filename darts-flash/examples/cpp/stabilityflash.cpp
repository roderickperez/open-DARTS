...
int main(int argc, char **argv)
{
    ...
    flash_params.eos_params["PR"]->trial_comps = {InitialGuess::Yi::Wilson, InitialGuess::Yi::Wilson13,
                                                  0
                                                  };
    ...
    if (diagram_type == PT)
    {
        ...
        for (auto p : pres)
        {
            for (auto t : temp)
            {
                ...
                std::shared_ptr<FlashResults> flash_results = stab_flash.get_flash_results();
