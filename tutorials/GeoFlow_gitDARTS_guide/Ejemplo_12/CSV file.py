...
if Select_case.case == '1':
    ...
    csv_path = os.path.join(new_directory, "Temp_sobre_linea_1.csv")
    output_img = os.path.join(new_directory, "grafico_Temp_1.png")
    
elif Select_case.case == '2':
    # Ruta del CSV generado
    csv_path = os.path.join(new_directory, "Temp_sobre_linea_2.csv")
    output_img = os.path.join(new_directory, "grafico_Temp_2.png")
