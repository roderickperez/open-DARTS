...
m.plot_init_phase_with_p_t( m.input_distribution['pressure'],      # Inicial
            m.input_distribution['temperature'],              # Inicial
            m.P_iny,                                          # Inyeccion  (aproximado)
            m.inj_temp + 273.15,                              # Inyeccion  (aproximado)
            m.P_prod,                                         # Produccion (aproximado)
            m.input_distribution['temperature'],              # Produccion (aproximado)
                         )
...
# plt.title("Enthalpy_W")
# plt.xlabel("x [m]")       
# plt.ylabel("Enthalpy_W [KJ/kg]")  
# plt.plot(x, estado_final['Enthalpy_W [KJ/kg]'][1], color="red")
# plt.savefig('Enthalpy_W.png', format='png')
# plt.show()


# plt.title("Enthalpy_S")
# plt.xlabel("x [m]")       
# plt.ylabel("Enthalpy_S [KJ/kg]")  
# plt.plot(x, estado_final['Enthalpy_S [KJ/kg]'][1], color="red")
# plt.savefig('Enthalpy_S.png', format='png')
# plt.show()
...
# plt.plot(x, estado_final['Dens_W'][1], color="red")
# plt.savefig('Water density.png', format='png')
# plt.show()


# plt.title("Steam density ")
# plt.xlabel("x [m]")       
# plt.ylabel("Density [kg/m3]")  
# plt.plot(x, estado_final['Dens_S'][1], color="red")
# plt.savefig('Steam density.png', format='png')
# plt.show()
