...
class Model(DartsModel):
    ...
    def set_physics(self, n_points):
        ...
        #                                    'Enthalpy_S [KJ/kg]': lambda: property_container.enthalpy[1]/18.01528,
                                            'Visco': lambda: property_container.mu[0],
    ...
    def set_well_controls(self):
        ...
        print('INJ mass rate [kmol/day]=',mol_rate_iny)
        print('INJ  temp. [c]=',self.inj_temp)

        self.Mass_prod=1.5                         #     [Kg/s] 
        mol_rate_prod=self.Mass_prod*4795.928784        #     [Kg/s]  --------> [kmol/day]
        print('\n---------Producer :')
        print('PROD mass rate [Kg/s]=',self.Mass_prod)
        print('PROD mass rate [Kg/day]=',self.Mass_prod*60*60*24)
        print('PROD mass rate [kmol/day]=',mol_rate_prod)
