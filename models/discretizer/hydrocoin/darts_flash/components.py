...
class ComponentProperties:
    def __init__(self):
        self.Tc = {"H2O": 647.14, "CO2": 304.10, "N2": 126.20, "H2S": 373.53, "C1": 190.58, "C2": 305.32, "C3": 369.83, "iC4": 407.85, "nC4": 425.12, "iC5": 460.45, "nC5": 469.70, "nC6": 507.60, "nC7": 540.20, "nC8": 569.32, "nC9": 594.6, "nC10": 617.7, }
        self.Pc = {"H2O": 220.50, "CO2": 73.75, "N2": 34.00, "H2S": 89.63, "C1": 46.04, "C2": 48.721, "C3": 42.481, "iC4": 36.4, "nC4": 37.960, "iC5": 33.77, "nC5": 33.701, "nC6": 30.251, "nC7": 27.40, "nC8": 24.97, "nC9": 22.88, "nC10": 21.2, }
        self.ac = {"H2O": 0.328, "CO2": 0.239, "N2": 0.0377, "H2S": 0.0942, "C1": 0.012, "C2": 0.0995, "C3": 0.1523, "iC4": 0.1844, "nC4": 0.2002, "iC5": 0.227, "nC5": 0.2515, "nC6": 0.3013, "nC7": 0.3495, "nC8": 0.396, "nC9": 0.445, "nC10": 0.489, }
        self.Mw = {"H2O": 18.015, "CO2": 44.01, "N2": 28.013, "H2S": 34.10, "C1": 16.043, "C2": 30.07, "C3": 44.097, "iC4": 58.124, "nC4": 58.124, "iC5": 72.151, "nC5": 72.151, "nC6": 86.178, "nC7": 100.205, "nC8": 114.231, "nC9": 128.257, "nC10": 142.2848, }
        self.kij = {"H2O": {"H2O": 0., "CO2": 0.19014, "N2": 0.32547, "H2S": 0.105, "C1": 0.47893, "C2": 0.5975, "C3": 0.5612, "iC4": 0.508, "nC4": 0.5569, "iC5": 0.5, "nC5": 0.5260, "nC6": 0.4969, "nC7": 0.4880, "nC8": 0.48, "nC9": 0.48, "nC10": 0.48, },
        ...
        self.h0 = {"CO2": 33., "N2": 0.64, "H2S": 100., "C1": 1.4, "C2": 1.9, "C3": 1.5, "iC4": 0.91, "nC4": 1.2, "iC5": 0.7, "nC5": 0.8, "nC6": 0.61, "nC7": 0.44, "nC8": 0.31, "nC9": 0.2, "nC10": 0.14, }
        self.dlnh = {"CO2": 2400., "N2": 1600., "H2S": 2100., "C1": 1900., "C2": 2400., "C3": 2700., "iC4": 2700., "nC4": 3100., "iC5": 3400., "nC5": 3400., "nC6": 3800., "nC7": 4100., "nC8": 4300., "nC9": 5000., "nC10": 5000., }
    ...
    def comp_data(self, components):
        ...
        for i, compi in enumerate(components):
            data["Pc"][i] = self.Pc[compi]
            data["Tc"][i] = self.Tc[compi]
            data["ac"][i] = self.ac[compi]
            data["Mw"][i] = self.Mw[compi]
