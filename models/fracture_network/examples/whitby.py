...
input_data['margin'] = None # [m]
input_data['frac_file'] = None
...
input_data['rsv_layers'] = None

#
input_data['overburden_thickness'] = None
input_data['overburden_layers'] = None
input_data['underburden_thickness'] = None
input_data['underburden_layers'] = None
