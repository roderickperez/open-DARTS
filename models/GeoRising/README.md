...
## Description
This model used one of the realization (#66) of [EGG model](https://data.4tu.nl/articles/dataset/The_Egg_Model_-_data_files/12707642) 
permeability for the first 3 layers (60x60x3) and without applied ACTNUM (ideal brick shape). The model contain geothermal doublet with injector located at 
