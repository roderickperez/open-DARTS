...
<p>Delft: 
    ...
    Engineering sections of the department.</p>
<p>Advanced: 
    ...
    core simulation engine. The framework is targeting the solution of forward and inverse problems.</p>
<p>Research: 
    ...
    reservoir simulation, inverse modeling and uncertainty quantification.</p>
<p>Terra: 
    ...
    Another focus is thermal-compositional processes for Enhanced Oil Recovery.</p>
<p>Simulator: 
    ...
    multiphase multicomponent flow.</p>