...
Scenario description:
    The same as the validation scenario 2, except the following parameters:
    inclination_angle = 45

Notes:
    Pay attention that If you change the wellbore inclination, the initial pressure profile changes as well, and
...
pipe_ID = 0.1 * meter()
inclination_angle = 45   # in degrees relative to the vertical direction
