"""
Injection of CO2 into a column of CO2 at a temperature higher than the CO2 critical temperature
...
Scenario description:
    ...
    reservoir_cell_perm_list = [20 * milli() * Darcy(), 20 * milli() * Darcy()]
...
start_time = 0 * second()
stop_time = "end"
injection_mass_rate = 30 * kg() / second()
...
reservoir_cell_perm_list = [20 * milli() * Darcy(), 20 * milli() * Darcy()]   # [Kx, Ky]
