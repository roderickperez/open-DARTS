...
Scenario description:
    ...
    injected_fluid_mole_fractions = [0.999, 0.001]
    reservoir_cell_perm_list = [4000 * milli() * Darcy(), 4000 * milli() * Darcy()]
...
# injection_specific_enthalpy = -7000 * Joule() / kg()  # Constant injection specific enthalpy   # For a 100-meter well
...
reservoir_cell_perm_list = [4000 * milli() * Darcy(), 4000 * milli() * Darcy()]   # [Kx, Ky]
