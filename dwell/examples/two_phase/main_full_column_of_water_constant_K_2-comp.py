...
Scenario description:
    Isothermal miscible 2-phase fluid flow with constant K values
    Impure CO2 injection into a wellbore full of water
    Constant mass rate/temperature at the wellhead
...
initial_fluid_conditions = {'phases_names': ['liquid'], 'phases_compositions': [[0.00001, 0.99999]],
...
start_time = 0 * second()
stop_time = "end"
injection_mass_rate = 0.2 * kg() / second()   # Constant injection mass rate   # For a 100-meter well
injection_mass_rate = 25 * kg() / second()

flow_direction = ["inflow", "along the pipe"]

injected_fluid_mole_fractions = [0.95, 0.05]
...
reservoir_fluid_mole_fractions = [0.00001, 0.99999]
