...
#%% Define fluid model
pipe_name = "Well1"
components_names = ["H2O"]
# Flash-calculations
flash_calcs_obj = None   # Single-phase fluid flow
# Density
density_obj = define_fluid_model.Density_Garcia2001(components_names)
# Enthalpy
...
# Viscosity
viscosity_obj = define_fluid_model.Viscosity_MaoDuan2009(["H2O"])
# IFT
...
start_time = 0 * second()
stop_time = "end"
injection_mass_rate = 30 * kg() / second()   # Constant injection mass rate   # For a 1-kilometer well
