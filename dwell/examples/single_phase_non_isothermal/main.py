...
# Pure CO2 injection
# Constant mass and enthalpy rate/temperature at the wellhead
...
pipe_name = "Well1"
segments_lengths = 10 * meter() * np.ones(10)   # For a 100-meter well
...
start_time = 0 * second()
stop_time = "end"
injection_mass_rate = 2 * kg() / second()   # Constant injection mass rate   # For a 100-meter well
...
# Consider that the initial temperature profile of the fluid in the pipe is the same as
# the temperature profile in the earth
...
# Either set a constant overall heat transfer coefficient (Ui)
# In "Development of a Transient, Multi-Feed Geothermal Wellbore Simulator", U = 20 W/(m2 * C) = 1.1356 BTU / (ft2 * hr * F) is used.
...
#                                                                verbose=verbose)
# or enter the information of the layers of the well
# well_layers_props = {"tubing": {"ID": 0,
#                                 "OD": 0,
#                                 "material": "Carbon Steel",
#                                 "tubing_head_depth": 0,
#                                 "tubing_bottom_depth": 0},
#                      "annulus": {"ID": 0,
#                                  "OD": 0,
#                                  "material": "Water",
#                                  "annulus_head_depth": 0,
#                                  "annulus_bottom_depth": 0},
#                      "casing_1": {"ID": 0,
#                                   "OD": 0,
#                                   "material": "Carbon Steel",
#                                   "casing_head_depth": 0,
#                                   "casing_bottom_depth": 0},
#                      "cement_1": {"ID": 0,
#                                   "OD": 0,
#                                   "material": "Portland",
#                                   "cement_head_depth": 0,
#                                   "cement_bottom_depth": 0},
#                      "casing_2": {"ID": 0,
#                                   "OD": 0,
#                                   "material": "Carbon Steel",
#                                   "casing_head_depth": 0,
...
#%% Time stepping
dt = 1 * second() * np.ones(400)
# dt = generate_rampup_time_steps(20, 1, 120)

# dt = generate_rampup_time_steps(20, 0.5 * minute(), 5 * minute())   # For a 100-meter well
# dt = generate_rampup_time_steps(20, 1, 2 * minute())   # For a 1-kilometer well
