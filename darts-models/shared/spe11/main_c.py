...
from fluidflower_str_c import FluidFlowerStruct
from fluidflower_unstr_c import FluidFlowerUnstruct
...
model_specs = [
    {'structured': True, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'nx': 150, 'nz': 75, 'output_dir': 'str_coarse_c'},
    # {'structured': True, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'nx': 300, 'nz': 150, 'output_dir': 'str_fine_c'},
    # {'structured': False, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'lc': [0.03, 0.003], 'output_dir': 'unstr_coarse_c'},
    # {'structured': False, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'lc': [0.015, 0.003], 'output_dir': 'unstr_fine_c'},
    # {'structured': True, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'nx': 600, 'nz': 300, 'output_dir': 'str_finer_c'},
    # {'structured': False, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'lc': [0.008, 0.003], 'output_dir': 'unstr_finer_c'},
]
