...
from fluidflower_str_a import FluidFlowerStruct
from fluidflower_unstr_a import FluidFlowerUnstruct
...
# need to fix krwe, krge, and labda

corey = {
    0: Corey(nw=1.5, ng=1.5, swc=0.32, sgc=0.10, krwe=1.0, krge=1.0, labda=2., p_entry=0.015),
    1: Corey(nw=1.5, ng=1.5, swc=0.14, sgc=0.10, krwe=1.0, krge=1.0, labda=2., p_entry=3e-3),
    2: Corey(nw=1.5, ng=1.5, swc=0.12, sgc=0.10, krwe=1.0, krge=1.0, labda=2., p_entry=1e-3),
    3: Corey(nw=1.5, ng=1.5, swc=0.12, sgc=0.10, krwe=1.0, krge=1.0, labda=2., p_entry=25e-5),
    4: Corey(nw=1.5, ng=1.5, swc=0.12, sgc=0.10, krwe=1.0, krge=1.0, labda=2., p_entry=10e-5),
    5: Corey(nw=1.5, ng=1.5, swc=0.10, sgc=0.10, krwe=1.0, krge=1.0, labda=2., p_entry=1e-5),
    6: Corey(nw=1.5, ng=1.5, swc=0.0, sgc=0.10, krwe=1.0, krge=1.0, labda=2., p_entry=1e-5)
}
...
layer_props = {900001: PorPerm(type='7', poro=1e-6, perm=1e-6, anisotropy=[1, 1, 1]),
               900002: PorPerm(type='5', poro=0.43, perm=4052999.88, anisotropy=[1, 1, 1]),
               900003: PorPerm(type='5', poro=0.43, perm=4052999.88, anisotropy=[1, 1, 1]),
               900004: PorPerm(type='5', poro=0.43, perm=4052999.88, anisotropy=[1, 1, 1]),
               900005: PorPerm(type='5', poro=0.43, perm=4052999.88, anisotropy=[1, 1, 1]),
               900006: PorPerm(type='5', poro=0.43, perm=4052999.88, anisotropy=[1, 1, 1]),
               900007: PorPerm(type='1', poro=0.44, perm=40529.9988, anisotropy=[1, 1, 1]),
               900008: PorPerm(type='1', poro=0.44, perm=40529.9988, anisotropy=[1, 1, 1]),
               900009: PorPerm(type='1', poro=0.44, perm=40529.9988, anisotropy=[1, 1, 1]),
               900010: PorPerm(type='4', poro=0.45, perm=2026499.94, anisotropy=[1, 1, 1]),
               900011: PorPerm(type='4', poro=0.45, perm=2026499.94, anisotropy=[1, 1, 1]),
               900012: PorPerm(type='4', poro=0.45, perm=2026499.94, anisotropy=[1, 1, 1]),
               900013: PorPerm(type='4', poro=0.45, perm=2026499.94, anisotropy=[1, 1, 1]),
               900014: PorPerm(type='4', poro=0.45, perm=2026499.94, anisotropy=[1, 1, 1]),
               900015: PorPerm(type='4', poro=0.45, perm=2026499.94, anisotropy=[1, 1, 1]),
               900016: PorPerm(type='3', poro=0.44, perm=1013249.97, anisotropy=[1, 1, 1]),
               900017: PorPerm(type='3', poro=0.44, perm=1013249.97, anisotropy=[1, 1, 1]),
               900018: PorPerm(type='3', poro=0.44, perm=1013249.97, anisotropy=[1, 1, 1]),
               900019: PorPerm(type='3', poro=0.44, perm=1013249.97, anisotropy=[1, 1, 1]),
               900020: PorPerm(type='3', poro=0.44, perm=1013249.97, anisotropy=[1, 1, 1]),
               900021: PorPerm(type='3', poro=0.44, perm=1013249.97, anisotropy=[1, 1, 1]),
               900022: PorPerm(type='4', poro=0.45, perm=2026499.94, anisotropy=[1, 1, 1]),
               900023: PorPerm(type='6', poro=0.46, perm=10132499.7, anisotropy=[1, 1, 1]),
               900024: PorPerm(type='6', poro=0.46, perm=10132499.7, anisotropy=[1, 1, 1]),
               900025: PorPerm(type='6', poro=0.46, perm=10132499.7, anisotropy=[1, 1, 1]),
               900026: PorPerm(type='2', poro=0.43, perm=506624.985, anisotropy=[1, 1, 1]),
               900027: PorPerm(type='2', poro=0.43, perm=506624.985, anisotropy=[1, 1, 1]),
               900028: PorPerm(type='2', poro=0.43, perm=506624.985, anisotropy=[1, 1, 1]),
               900029: PorPerm(type='2', poro=0.43, perm=506624.985, anisotropy=[1, 1, 1]),
               900030: PorPerm(type='2', poro=0.43, perm=506624.985, anisotropy=[1, 1, 1]),
               900031: PorPerm(type='7', poro=1e-6, perm=1e-6, anisotropy=[1, 1, 1]),
               900032: PorPerm(type='1', poro=0.44, perm=40529.9988, anisotropy=[1, 1, 1]),
               }
...
model_specs = [
    {'structured': True, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'nx': 150, 'nz': 75, 'output_dir': 'str_coarse_a'},
    # {'structured': True, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'nx': 300, 'nz': 150, 'output_dir': 'str_fine_a'},
    # {'structured': False, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'lc': [0.03, 0.003], 'output_dir': 'unstr_coarse_a'},
    # {'structured': False, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'lc': [0.015, 0.003], 'output_dir': 'unstr_fine_a'},
    # {'structured': True, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'nx': 600, 'nz': 300, 'output_dir': 'str_finer_a'},
    # {'structured': False, 'thickness': False, 'curvature': False, 'tpfa': True, 'capillary': True, 'lc': [0.008, 0.003], 'output_dir': 'unstr_finer_a'},
]
...
for j, specs in enumerate(model_specs):
    ...
    # m.reservoir.min_depth = 1e-6
    m.p_prod = pres_in + m.reservoir.min_depth * 0.1 if hasattr(m.reservoir, "min_depth") else pres_in + 1e-6
    ...
    # m.reservoir.wells[0].control = m.physics.new_bhp_inj(1.2, m.inj_stream)
    first_ts = 1e-8
    for i in range(num_report_steps):

        print('\n---------------------------SELF-PRINT #%d---------------------------' % (i + 1))

        if m.physics.engine.t > 0.104167 - eps and event1:
