...
#copy all linux libs 
smbclient -U $2%$3 //$1/darts-private-artifacts/ -c 'prompt OFF;mget *.a' -D darts-linear-solvers/lib
cd ../include
#copy headers
smbclient -U $2%$3 //$1/darts-private-artifacts/ -c 'prompt OFF;mget *.h' -D darts-linear-solvers/include
