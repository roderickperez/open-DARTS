#ifndef GPU_SIMULATOR_CU_NC3_H
#define GPU_SIMULATOR_CU_NC3_H
...
class conn_mesh;
class interp_table_3d;
class sim_params;


class gpu_simulator_nc3 : public engine_base
{
  ...
  interp_table_3d *acc1, *acc2;
  interp_table_3d *flu1, *flu2;
  interp_table_3d *acc3, *flu3;
  ...
  value_t *gpu_acc3_data;
  interp_value_t *gpu_acc3_res;

  interp_value_t *gpu_acc_n_res;
  ...
  value_t *gpu_flu3_data;
  interp_value_t *gpu_flu3_res;
